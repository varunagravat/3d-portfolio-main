...
const HeroSection = () => {
  ...
  const getDecorativeImages = useCallback((): TAnimateImageProps[] => {
    return [
      {
        className: "w-[120px] lg:w-[150px] lg:h-[150px] top-3 -left-16",
        src: ASSETS.decoratives.androidIcon,
        width: 150,
        height: 150,
        initial: { x: -100 },
      ...
      {
        className: "w-[110px] lg:w-[140px] lg:h-[140px] top-6 -right-12",
        src: ASSETS.decoratives.sqlIcon,
        width: 140,
        height: 140,
        initial: { x: 100 },
        animate: inView ? { opacity: 1, x: 0 } : {},
      ...
      {
        className: "w-[120px] lg:w-[150px] lg:h-[150px] bottom-6 -left-14",
        src: ASSETS.decoratives.flutterIcon,
        width: 150,
        height: 150,
        initial: { x: -100 },
        animate: inView ? { opacity: 1, x: 0 } : {},
      ...
      {
        className: "w-[130px] lg:w-[160px] lg:h-[160px] bottom-8 -right-24",
        src: ASSETS.decoratives.kotlinIcon,
        width: 160,
        height: 160,
        initial: { x: 100 },
        animate: inView ? { opacity: 1, x: 0 } : {},
